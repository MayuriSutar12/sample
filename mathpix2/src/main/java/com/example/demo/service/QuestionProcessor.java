...
@StepScope
public class QuestionProcessor implements ItemProcessor<QuestionDataTemp, QuestionDataTemp> {
    ...
    @Override
    public QuestionDataTemp process(QuestionDataTemp question) throws Exception {
        ...
        try {
            ...
            question.setQuestionLatex(finalLatex);
            ...
            if (existingSolution != null) {
                existingSolution.setSolutionLatex("Ans :" + questionJsonDTO.getAnswerKey() + " " + questionJsonDTO.getSolutionLatex());
